...
!((a, b) => {
	...
	(r.fn = r.prototype =
		...
		r.extend({
			...
			isNumeric: (a) => {
				var b = r.type(a);
				return (
					("number" === b || "string" === b) && !isNaN(a - Number.parseFloat(a))
				);
			},
			isPlainObject: (a) => {
				var b, c;
			...
			(d = ga.selectors =
				{
					...
					filter: {
						TAG: (a) => {
							...
							return "*" === a
								? () => !0
								: (a) => a.nodeName && a.nodeName.toLowerCase() === b;
						},
						CLASS: (a) => {
							var b = y[a + " "];
							return (
			...
			: b.nodeType
				...
				: "string" != typeof b
					...
					: C.test(b)
						? r.filter(b, a, c)
						: ((b = r.filter(b, a)),
							r.grep(a, (a) => i.call(b, a) > -1 !== c && 1 === a.nodeType));
	}
	(r.filter = (a, b, c) => {
		var d = b[0];
		return (
	...
	r.each(
		{
			...
			parentsUntil: (a, b, c) => y(a, "parentNode", c),
			next: (a) => J(a, "nextSibling"),
			prev: (a) => J(a, "previousSibling"),
			nextAll: (a) => y(a, "nextSibling"),
			prevAll: (a) => y(a, "previousSibling"),
			nextUntil: (a, b, c) => y(a, "nextSibling", c),
			prevUntil: (a, b, c) => y(a, "previousSibling", c),
			...
			if (q) {
				c.handler && ((f = c), (c = f.handler), (e = f.selector)),
					...
					(g = q.handle) ||
						(g = q.handle =
							(b) =>
								"undefined" != typeof r && r.event.triggered !== b.type
	...
	r.extend({
		...
		css: (a, b, c, d) => {
			...
			return (
				...
				"" === c || c
					? ((f = Number.parseFloat(e)), c === !0 || isFinite(f) ? f || 0 : e)
					: e
			);
		},
	}),
		...
		(r.cssHooks.marginLeft = Oa(o.reliableMarginLeft, (a, b) => {
			if (b)
				return (
					(Number.parseFloat(Na(a, "marginLeft")) ||
	...
	r.fn.extend({
		...
		(Ya = {
			set: (a, b, c) => (
				b === !1 ? r.removeAttr(a, c) : a.setAttribute(c, c), c
			),
		}),
	...
	r.fn.extend({
		...
		r.each(["radio", "checkbox"], function () {
			(r.valHooks[this] = {
				...
				o.checkOn ||
					(r.valHooks[this].get = (a) =>
						null === a.getAttribute("value") ? "on" : a.value);
		});
		...
		setOffset: (a, b, c) => {
			...
			"static" === k && (a.style.position = "relative"),
				...
				j
					...
					: ((g = Number.parseFloat(f) || 0), (e = Number.parseFloat(i) || 0)),
	...
	return (
		(r.noConflict = (b) => (
			a.$ === r && (a.$ = lb), b && a.jQuery === r && (a.jQuery = kb), r
		)),
		b || (a.jQuery = a.$ = r),
		r
	);
