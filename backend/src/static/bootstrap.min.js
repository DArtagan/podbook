		...
		var i =
			...
			r = ((t) => {
				...
				function r(e) {
					var i = !1;
					return (
						t(this).one(c.TRANSITION_END, () => {
							i = !0;
						}),
						setTimeout(() => {
							i || c.triggerTransitionEnd(this);
						}, e),
						this
					);
				}
				...
				var a = !1,
					...
					c = {
						...
						supportsTransitionEnd: () => Boolean(a),
			...
			s =
				(((t) => {
					var e = "alert",
						...
						_ = (() => {
							...
							return (
								...
								(e.prototype._triggerCloseEvent = (e) => {
										...
										r.supportsTransitionEnd() && t(e).hasClass(f.FADE)
											? void t(e)
													.one(r.TRANSITION_END, (t) =>
														this._destroyElement(e, t),
													)
													.emulateTransitionEnd(c)
											: void this._destroyElement(e)
									);
								}),
								(e.prototype._destroyElement = (e) => {
					...
					return (
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = h), _._jQueryInterface)),
						_
					);
				})(jQuery),
				((t) => {
				...
				((t) => {
							...
							return (
								...
								(h.prototype.to = function (e) {
									...
									if (!(e > this._items.length - 1 || e < 0)) {
										if (this._isSliding)
											return void t(this._element).one(m.SLID, () =>
												this.to(e),
											);
								...
								(h.prototype._getConfig = (n) => (
									(n = t.extend({}, _, n)), r.typeCheckConfig(e, n, g), n
								)),
								(h.prototype._addEventListeners = function () {
									this._config.keyboard &&
										t(this._element).on(m.KEYDOWN, (t) => this._keydown(t)),
										"hover" !== this._config.pause ||
											"ontouchstart" in document.documentElement ||
											t(this._element)
												.on(m.MOUSEENTER, (t) => this.pause(t))
												.on(m.MOUSELEAVE, (t) => this.cycle(t));
								}),
								...
								(h.prototype._slide = function (e, n) {
									var o = t(this._element).find(v.ACTIVE_ITEM)[0],
												...
												t(o)
													.one(r.TRANSITION_END, () => {
														t(s)
															...
															(this._isSliding = !1),
															setTimeout(() => t(this._element).trigger(f), 0);
													})
					...
					return (
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = c), T._jQueryInterface)),
						T
					);
				})(jQuery),
				((t) => {
					var e = "collapse",
						...
						E = (() => {
							...
							return (
											...
											if (
												...
												var h = () => {
													t(this._element)
														...
														t(this._element).trigger(_.SHOWN);
												};
								...
								(l.prototype._addAriaAndCollapsedClass = (e, n) => {
									if (e) {
					...
					return (
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = c), E._jQueryInterface)),
						E
					);
				})(jQuery),
				((t) => {
					...
					return (
						t(document)
							...
							.on(_.CLICK_DATA_API, p.FORM_CHILD, (t) => {
								t.stopPropagation();
							}),
						(t.fn[e] = m._jQueryInterface),
						(t.fn[e].Constructor = m),
						(t.fn[e].noConflict = () => ((t.fn[e] = h), m._jQueryInterface)),
						m
					);
				})(jQuery),
				((t) => {
						...
						v = (() => {
							...
							return (
								...
								(h.prototype.show = function (e) {
									...
									t(this._element).trigger(i),
										this._isShown ||
											...
											t(this._dialog).on(p.MOUSEDOWN_DISMISS, () => {
												t(this._element).one(p.MOUSEUP_DISMISS, (e) => {
													t(e.target).is(this._element) &&
								...
								(h.prototype.hide = function (e) {
									...
									t(this._element).trigger(o),
										this._isShown &&
											...
											i
												? t(this._element)
														.one(r.TRANSITION_END, (t) => this._hideModal(t))
														.emulateTransitionEnd(u)
												: this._hideModal());
								}),
								(h.prototype.dispose = function () {
									...
									t(document)
										...
										.on(p.FOCUSIN, (n) => {
											document === n.target ||
												...
												t(this._element).has(n.target).length ||
												this._element.focus();
										});
								}),
								(h.prototype._setEscapeEvent = function () {
									this._isShown && this._config.keyboard
										? t(this._element).on(p.KEYDOWN_DISMISS, (t) => {
												t.which === f && this.hide();
											})
								...
								(h.prototype._setResizeEvent = function () {
									this._isShown
										? t(window).on(p.RESIZE, (t) => this._handleUpdate(t))
									...
									(this._element.style.display = "none"),
										...
										this._showBackdrop(() => {
											t(document.body).removeClass(m.OPEN),
												...
												t(this._element).trigger(p.HIDDEN);
										});
								}),
								...
								(h.prototype._showBackdrop = function (e) {
									var i = t(this._element).hasClass(m.FADE) ? m.FADE : "";
									if (this._isShown && this._config.backdrop) {
										...
										if (
											...
											t(this._element).on(p.CLICK_DISMISS, (t) =>
								...
								(h.prototype._getScrollbarWidth = () => {
					...
					return (
						t(document).on(p.CLICK_DATA_API, E.DATA_TOGGLE, function (e) {
							...
							("A" !== this.tagName && "AREA" !== this.tagName) ||
								e.preventDefault();
							var l = t(i).one(p.SHOW, (e) => {
								e.isDefaultPrevented() ||
									l.one(p.HIDDEN, () => {
										t(this).is(":visible") && this.focus();
									});
							});
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = c), v._jQueryInterface)),
						v
					);
				})(jQuery),
				((t) => {
						...
						m = (() => {
							function h(e, i) {
								n(this, h),
									...
									t(this._scrollElement).on(f.SCROLL, (t) => this._process(t)),
									this.refresh(),
									this._process();
							}
							return (
					...
					return (
						...
						(t.fn[e] = m._jQueryInterface),
						(t.fn[e].Constructor = m),
						(t.fn[e].noConflict = () => ((t.fn[e] = c), m._jQueryInterface)),
						m
					);
				})(jQuery),
				((t) => {
									...
									if (
										...
										if (
											...
											var h = () => {
												...
												t(i).trigger(n), t(this._element).trigger(o);
											};
				...
				((t) => {
							...
							return (
								...
								(h.prototype.show = function () {
									...
									if (this.isWithContent() && this._isEnabled) {
										...
										var d = () => {
											...
											(this._hoverState = null),
												(this._isTransitioning = !1),
												t(this.element).trigger(this.constructor.Event.SHOWN),
												n === g.OUT && this._leave(null, this);
										};
										if (
											r.supportsTransitionEnd() &&
								...
								(h.prototype.hide = function (e) {
									...
									if (this._isTransitioning)
										throw new Error("Tooltip is transitioning");
									var s = () => {
										this._hoverState !== g.SHOW &&
											i.parentNode &&
											i.parentNode.removeChild(i),
											this.element.removeAttribute("aria-describedby"),
											t(this.element).trigger(this.constructor.Event.HIDDEN),
											(this._isTransitioning = !1),
											this.cleanupTether(),
											e && e();
									};
								...
								(h.prototype._getAttachment = (t) => _[t.toUpperCase()]),
								(h.prototype._setListeners = function () {
									...
									n.forEach((n) => {
										if ("click" === n)
											...
											t(this.element)
												.on(i, this.config.selector, (t) => this._enter(t))
												.on(o, this.config.selector, (t) => this._leave(t));
										}
										t(this.element)
											.closest(".modal")
					...
					return (
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = h), I._jQueryInterface)),
						I
					);
				})(jQuery));
		((r) => {
			...
			return (
				...
				(r.fn[a].noConflict = () => ((r.fn[a] = u), m._jQueryInterface)),
				m
			);
		})(jQuery);
	})();
